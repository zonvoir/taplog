    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card ">
                ...
                <div class="card-body">
                   	<h4>Vehicle: {{ isset($vehicle_status) ? $vehicle_status->vehicle->vehicle_no : '' }}</h4>
                   	<h4>Trip ID: {{ isset($vehicle_status) ? $vehicle_status->trip->trip_id : '' }}</h4>
                   	<h4>Last Location: Lat: {{ isset($vehicle_status) ? $vehicle_status->lat : '' }}, Lng: {{ isset($vehicle_status) ? $vehicle_status->lng : '' }}</h4>
