                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action_btn_cust">
                                                <a href="{{public_path($site->insurance_doc)}}" download>Download</a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="action_btn_cust">
                                                <a href="{{public_path($site->fitness_cert_doc)}}" download>Download</a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="action_btn_cust">
                                                <a href="{{public_path($site->permit_doc)}}" download>Download</a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="action_btn_cust">
                                            	<a href="{{route('vehicle-status',$site->id)}}">Current Status</a>
                                            	<a href="{{route('vehicle-run-data',$site->id)}}">Run Data</a>
                                            </div>
                                        </td>
                                    </tr>
                                    @endforeach
