		...
		<div class="offcanvas-content pr-5 mr-n5">
			...
			<div class="d-flex align-items-center mt-5">
				...
				<div class="d-flex flex-column">
					...
					<div class="text-muted mt-1">{{auth()->user()->type == 'subadmin' ? 'Admin' : (auth()->user()->type == 'mis' ? 'MIS' : (auth()->user()->type == 'filler' ? 'Filler' : (auth()->user()->type == 'driver' ? 'Driver' : (auth()->user()->type == 'field_officer' ? 'Area Oficer' : ''))) )}}</div>
					<div class="navi mt-2">
