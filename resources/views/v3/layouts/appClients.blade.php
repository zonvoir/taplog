...
<body class="{{ $class ?? '' }}">
    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            @include('layouts.navbars.navbarClients')
    ...
    @else
    @include('layouts.navbars.navbarMis')
        ...
        $(document).ready(function() {
                ...
                exportOptions: {
                    ...
                    format: {
                        body: function ( data, row, column, node ) {
                            return (column === 25 || column === 9 || column === 11 || column === 12 || column === 14 || column === 21) && data != null ? '<a target="_blank" href="{{ URL::to("/images/")}}/'+data+'"><img src="{{ URL::to("/images/")}}/'+data+'"></a>' : data;
                        }
                    },
            ...
            },
            {
                ...
                exportOptions: {
                    ...
                    format: {
                        body: function ( data, row, column, node ) {
                            return (column === 23 || column === 7 || column === 9 || column === 10|| column === 12 || column === 19) && data != null ? '{{ URL::to("/images/")}}/'+data : data;
                        }
                    },
                    columns: "thead th:not(.noExport)"
                },
            ...
            // },
            {
                ...
                "render": function(data,type,data1){
                    let lefting_date = data1.lefting_date;
                    let anchor_tag = lefting_date ? '<a href="{{url("edit-collection")}}/'+data+'" class="btn btn-primary btn-sm btn-icon"><i class="tim-icons icon-pencil"></i></a>' : '<a href="{{url("create-collection")}}/'+data+'" class="btn btn-success btn-sm btn-icon"><i class="tim-icons icon-simple-add"></i></a>'
                    return anchor_tag;
                }
            },
            { 
            ...
            { 
                ...
                "render": function(data,type){
                    let imgtag = data ? '<img style="height: 30px; width: 20px; cursor: pointer;" onclick="zoomImage(this);" class="myImg" src="{{ URL::to("/images/")}}/'+data+'">' : data;
                    return imgtag;
                }
            },
            { "data": "hmr_reading" },
            ...
            { 
                "data": "handbook_img",
                "render": function(data,type){
                    let imgtag = data ? '<a href="{{ URL::to("/images/")}}/'+data+'" download><img style="height: 30px; width: 20px; cursor: pointer;" class="myImg" src="{{ URL::to("/images/")}}/'+data+'"></a>' : data;
                    return imgtag;
                }
            },
            {
