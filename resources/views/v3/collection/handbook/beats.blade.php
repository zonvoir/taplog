...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
      ...
      <div class="card card-custom">
        <div class="card-header">
          <div class="card-title">
            ...
            <h3 class="card-label">All Beat Plans</h3>
          </div>
          ...
          <div class="card-body table-item-wrap">
            ...
            <!--begin: Datatable-->
            <table class="table table-bordered table-hover table-checkable" id="handbook_beat_data_table" style="margin-top: 13px !important">
              <thead>
                <tr>
                  <th>Client Name</th>
                  <th>Plan Date</th>
  ...
  <script src="{{ asset('public') }}/assets/js/pages/crud/datatables/data-sources/handbook-beat-data-ajax.js"></script>
  @endpush