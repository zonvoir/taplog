...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
      ...
      <div class="d-flex align-items-center flex-wrap mr-1">
        ...
        <div class="d-flex align-items-baseline flex-wrap mr-5">
          <!--begin::Page Title-->
          <h5 class="text-dark font-weight-bold my-1 mr-5">Beat Plans's</h5>
          <!--end::Page Title-->
          <!--begin::Breadcrumb-->
      ...
      <div class="card card-custom">
        <div class="card-header">
          <div class="card-title">
            ...
            <h3 class="card-label">All Trip's</h3>
          </div>
          ...
          <div class="card-body table-item-wrap">
              ...
              <div class="row mb-8">
                <div class="col-lg-6 mb-lg-0 mb-6">
                  ...
                  <div class="input-daterange input-group" id="kt_datepicker">
                    <input type="text" class="form-control datatable-input" name="start" placeholder="From" data-col-index="0" />
                    <div class="input-group-append">
                      <span class="input-group-text">
                        <i class="la la-ellipsis-h"></i>
                      </span>
                    </div>
                    <input type="text" class="form-control datatable-input" name="end" placeholder="To" data-col-index="0" />
                  </div>
                </div>
            ...
            <!--begin: Datatable-->
            <table class="table table-bordered table-hover table-checkable" id="handbook_trip_data_table" style="margin-top: 13px !important">
              <thead>
                <tr>
                  <th>Plan Date</th>
                  <th>Trip Id</th>
  ...
  <script src="{{ asset('public') }}/assets/js/pages/crud/datatables/data-sources/handbook-trip-data-ajax.js"></script>
  @endpush