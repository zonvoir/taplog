	...
	<div class="card card-custom">
		<div class="card-header">
			<div class="card-title">
				...
				<h3 class="card-label">Trip Edit</h3>
			</div>
		</div>
		<div class="card-body">
			<form id="trip-allot-form" action="{{route('trip.update',$trip)}}" method="POST" enctype="multipart/form-data" autocomplete="off">
				@csrf
				...
				<div class="card-body">
					<div class="form-group row">
					   	<div class="col-lg-6">
						    ...
						    <input type="text" class="form-control" id="current_date" name="current_date" placeholder="Date" required="" value="{{ $trip->beat_plan->added_date }}" readonly=""/>
					   	</div>
					   	<div class="col-lg-6">
						    <label for="zone">MP/Zone:</label>
						    <div class="typeahead">
								
								<input type="text" id="zone" name="zone" class="form-control typeahead" placeholder="MP/Zone" value="{{ $trip->beat_plan->mp_zone }}" required />
							</div>
					...
					<div class="form-group row">
					   	<div class="col-lg-6">
						    ...
						    <input type="text" id="effective_date" name="" value="{{ $trip->effective_date }} {{ $trip->beat_plan->client->vendor_code }}" class="typeahead form-control"  placeholder="Proposed date Ex. dd-mm-yyyy"  readonly >
					   	...
					   	<div class="col-lg-6">
						    ...
						    <div class="input-group">
						    <input type="text" id="route1" name="route" value="{{ $trip->route->route_name }}" class="form-control"  placeholder="Enter Route Name" required="" >
					...
					<div class="form-group row">
					   	<div class="col-lg-6">
							...
							<select name="loading_point" id="loading_point" class="form-control select2" required>
					...
					<div class="tab-content mt-5" id="tripExtraDataTabContent">
								...
								<div class="form-group row">
									...
									<div data-repeater-list="siteArray" class="col-lg-12">
										...
										<div data-repeater-item class="form-group row align-items-center site_row">
											<div class="col">
												<label>Site Id:</label>
												<input type="hidden" name="tripdataid"  value="{{ $trip_data->id }}">
												<input type="hidden" name="siteid" class="siteid" value="{{ $trip_data->data_id }}">
												<input type="hidden" name="beatplanid" class="beatplanid" value="{{ $trip_data->beatplan_id }}">
												<input type="hidden" name="beatplandataid" class="beatplandataid" value="{{ $trip_data->quantity()->id }}">
												<input type="text" name="site_id" class="form-control clone_site_id" placeholder="Site ID" value="{{ $trip_data->site->site_id }}" />
												<div class="d-md-none mb-2"></div>
											</div>
											<div class="col">
												<label>Site Name</label>
												<input type="text" class="form-control site_name" name="site_name" placeholder="Site Name" value="{{ $trip_data->site->site_name }}" readonly />
												<div class="d-md-none mb-2"></div>
											</div>
											<div class="col">
												<label>Quantity</label>
												<input type="text" name="quantity" class="form-control quantity" placeholder="Quantity" value="{{ $trip_data->quantity()->quantity }}" readonly />
												<div class="d-md-none mb-2"></div>
											</div>
											<div class="col">
												<label>Technician Name</label>
												<input type="text" name="technician_name" class="form-control technician_name" value="{{ $trip_data->site->technician_name }}" placeholder="Technician Name" readonly />
												<div class="d-md-none mb-2"></div>
											</div>
						...
						<div class="tab-pane fade" id="assets-tab-content" role="tabpanel" aria-labelledby="assets-tab">
							<div id="asset-repeater">
								<div class="form-group row">
									@php 
										$assets = json_decode($trip->assets);
										$asset_qty = json_decode($trip->asset_qty);
									@endphp
										...
										@if(!empty($assets) && count($assets))
											...
											<div data-repeater-item class="form-group row align-items-center">
												<div class="col">
													...
													<input type="text" name="asset_name" class="form-control asset_name" placeholder="Enter Asset Name" value="{{ $asset }}" />
													<div class="d-md-none mb-2"></div>
												</div>
												<div class="col">
													<label>Quantity Allocated</label>
													<input type="number" name="qty_allocate" class="form-control qty_allocate" placeholder="Enter Quantity" value="{{ $asset_qty[$key]??0 }}" />
													<div class="d-md-none mb-2"></div>
												</div>
												<div class="col">
													<label style="opacity: 0;">L</label>
						...
						<div class="tab-pane fade" id="client-tab-content" role="tabpanel" aria-labelledby="clients-tab">
							<div id="client-repeater">
								<div class="form-group row">
									@php 
										$names = json_decode($trip->clients_name);
										$mobiles = json_decode($trip->clients_mobile);
										$emails = json_decode($trip->client_email);
									@endphp
									
									<!-- <label class="col-lg-2 col-form-label text-right">Sites:</label> -->
									<div data-repeater-list="clientArray" class="col-lg-12">
										@if(!empty($names) && count($names))
											@foreach($names as $key=>$name)
											<div data-repeater-item class="form-group row align-items-center">
												<div class="col">
													<label>Client Name:</label>
													<input type="text" name="client_name" class="form-control client_name" placeholder="Client Name" value="{{ $name }}" />
													<div class="d-md-none mb-2"></div>
												</div>
												<div class="col">
													<label>Client Mobile</label>
													<input type="text" name="client_mobile" class="form-control client_mobile" placeholder="Client Mobile" value="{{ $mobiles[$key] ?? '' }}"  />
													<div class="d-md-none mb-2"></div>
												</div>
												<div class="col">
													<label>Client Email</label>
													<input type="email" name="client_email" class="form-control client_email" placeholder="Client Email" value="{{ $emails[$key] ?? '' }}"  />
													<div class="d-md-none mb-2"></div>
												</div>
												<div class="col">
													<label style="opacity: 0;">L</label>
				...
				<div class="card-footer">
					<div class="row">
						<div class="col-lg-6">
							<button type="button" onclick="submitForm();" class="btn btn-primary mr-2">Update</button>
...
<script type="text/javascript">
	    ...
	    $("#site-repeater").repeater({
            ...
            show: function () {
                ...
                $(this).find('.clone_site_id').typeahead({
					source: function(query, process) {
						return $.get(HOST_URL+'trip/site-details-trip', {
	...
	function submitForm(){
		...
		$(".trip_id_span").text($("#trip_id_value90").val());
		...
		data += ' Route Plan: '+$("#route1").val();
		data += ' Vehicle No.: '+$("#vehicale_number").val();
		data += ' Trip Id: '+$("#trip_id_value90").val();
