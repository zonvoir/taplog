@extends('v3.layouts.app', ['page' => __('Asset Edit'), 'pageSlug' => 'assets_master'])
@section('content')
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" name="qty" class="form-control{{ $errors->has('qty') ? ' is-invalid' : '' }}" placeholder="{{ __('Quantity') }}" value="{{$asset->item_name}}" required="">
            ...
            <div class="row">
                <div class="col-md-6 pr-md-1">
                    <div class="form-group">
                        <label>{{ __('UAM') }}</label>
                        <input type="text" name="uam" class="form-control{{ $errors->has('uam') ? ' is-invalid' : '' }}" placeholder="{{ __('UAM') }}" value="{{$asset->item_name}}" required="">
            ...
            <div class="row">
                 <div class="col-md-6 pr-md-1">
                        ...
                        <input type="text" name="mapped_with_mp" class="form-control{{ $errors->has('mapped_with_mp') ? ' is-invalid' : '' }}" value="{{$asset->mapped_with_mp}}" placeholder="{{ __('Mapped With MP') }}" required="">
                ...
                <div class="col-md-6 pr-md-1">
                    <div class="form-group">
                        ...
                        <input type="text" name="mapped_with_customer" class="form-control{{ $errors->has('mapped_with_customer') ? ' is-invalid' : '' }}" placeholder="{{ __('Mapping with Customer') }}" value="{{$asset->mapped_with_customer}}" required="">
