	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<div class="row">
					<div class="col-md-6"><h4 class="card-title">Not Filled Backlogs</h4></div>
				</div>
			</div>
			<div class="card-body">
				<div class="table-responsive">
					<table class="table tablesorter " id="">
						...
						<tbody>
						  ...
						  <tr>
							<td>
							  <a href="{{ route('backlog.index') }}?type=not_filled_data&beat_id={{$plan->plan_id}}">{{ $plan->effective_date }}</a>
							</td>
							<td>
							  {{ $plan->mp_zone }}
							</td>
