            ...
            <div>
                ...
                <div class="text-muted"></div>
                                                ...
                                                <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                                                    ...
                                                    <div class="navi-item mb-2">
                                                        <a href="http://localhost/taplog/user/16/edit" class="navi-link py-4 active">
                                                            <span class="navi-icon mr-2">
                                                                <span class="svg-icon">
                                                    ...
                                                    <div class="navi-item mb-2">
                                                        <a href="{{route('user.marital',$user->id)}}" class="navi-link py-4">
                                                            <span class="navi-icon mr-2">
                                                                <span class="svg-icon">
                                                                    <!--begin::Svg Icon | path:assets/media/svg/icons/General/User.svg-->
                                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    ...
                                                    @endif
                                                    <div class="navi-item mb-2">
                                                        <a href="{{route('user.contact',$user->id)}}" class="navi-link py-4">
                                                            <span class="navi-icon mr-2">
                                                    ...
                                                    <div class="navi-item mb-2">
                                                        <a href="{{route('user.kyc',$user->id)}}" class="navi-link py-4">
                                                            <span class="navi-icon mr-2">
                                                    ...
                                                    <div class="navi-item mb-2">
                                                        <a href="{{route('user.password',$user->id)}}" class="navi-link py-4">
                                                            <span class="navi-icon mr-2">
                                                                <span class="svg-icon">
