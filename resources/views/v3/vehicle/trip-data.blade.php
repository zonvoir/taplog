...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
      ...
      <div class="card card-custom">
        <div class="card-header">
          <div class="card-title">
            ...
            <h3 class="card-label">Trip Data</h3>
          </div>
          ...
          <div class="card-body table-item-wrap">
            <!--begin: Datatable-->
            <table class="table table-striped- table-bordered table-hover table-checkable dataTable dtr-inline" id="vehicle_trip_data_table" style="margin-top: 13px !important">
              <thead>
                <tr>
                  <th>Trip Id</th>
                  <th>Site ID</th>
  ...
  <script src="{{ asset('public') }}/assets/js/pages/crud/datatables/data-sources/vehicle-trip-data-ajax.js"></script>
  @endpush