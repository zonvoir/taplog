@extends('v3.layouts.app', ['page' => __('Update Vehicle'), 'pageSlug' => 'vendors-vehicle'])
@section('content')
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
  ...
  <div class="d-flex flex-column-fluid">
    ...
    <div class="container">
      ...
      <div class="card card-custom">
        ...
        <!--begin::Form-->
        <form class="form" id="vehicle-update-form" action="{{ route('vehicle.update',$vehicle->id) }}" method="post" enctype="multipart/form-data" autocomplete="off">
          @csrf
          @method('put')
          ...
          <div class="card-body">
            <div class="form-group row">
              <div class="col-lg-6">
                ...
                <input type="text" name="vehicle_no" class="form-control" placeholder="Enter vehicle number" required="" value="{{$vehicle->vehicle_no}}" />
           ...
           <div class="form-group row">
            <div class="col-lg-4">
              ...
              <input type="text" name="insurance_no" class="form-control" placeholder="Insurance Policy Number" value="{{$vehicle->insurance_no}}"/>
              <span class="form-text text-muted"></span>
            </div>
            <div class="col-lg-4">
           ...
           <div class="col-lg-4">
            ...
            <input type="text" name="insurance_upto" class="form-control kt_datepicker_3" placeholder="Insuarnce UpTo" value="{{$vehicle->insurance_upto}}"/>
            <span class="form-text text-muted"></span>
          </div>
        </div>
        <div class="form-group row">
          <div class="col-lg-4">
            ...
            <input type="text" name="fitness_cert_no" class="form-control" placeholder="Fitness Certificate Number" value="{{$vehicle->fitness_cert_no}}"/>
            <span class="form-text text-muted"></span>
          </div>
          <div class="col-lg-4">
         ...
         <div class="col-lg-4">
          ...
          <input type="text" id="" name="fitness_cert_upto" class="form-control kt_datepicker_3" placeholder="Fitness Certificate Valid Upto" value="{{$vehicle->fitness_cert_upto}}"/>
          <span class="form-text text-muted"></span>
        </div>
      </div>
      <div class="form-group row">
        <div class="col-lg-4">
          ...
          <input type="text" name="permit_no" class="form-control" placeholder="Permit Number" value="{{$vehicle->permit_no}}"/>
          <span class="form-text text-muted"></span>
        </div>
        <div class="col-lg-4">
       ...
       <div class="col-lg-4">
        ...
        <input type="text" id="" name="permit_upto" class="form-control kt_datepicker_3" placeholder="Permit Valid Upto" value="{{$vehicle->permit_upto}}"/>
        <span class="form-text text-muted"></span>
      </div>
    </div>
  </div>
  <div class="card-footer">
    <div class="row">
      <div class="col-lg-2">
        <button style="width: 100%;" type="submit" class="btn font-weight-bold btn-success mr-2">{{ __('Update') }}</button></div>
        <div class="col-lg-2">
...
<script type="text/javascript">
  const fv = FormValidation.formValidation(
    document.getElementById('vehicle-update-form'),
    {
      fields: {
        vehicle_no: {
          validators: {
