                ...
                <form class="form" id="vehicle-create-form" action="{{route('vehicle.store')}}" method="post" autocomplete="off">
                    ...
                    <div class="card-body">
                     ...
                     <div class="col-lg-4">
                        ...
                        <input type="text" id="kt_datepicker_3" name="insurance_upto" class="form-control" placeholder="Insuarnce UpTo"/>
                        <span class="form-text text-muted"></span>
                    </div>
                </div>
                <div class="form-group row">
                 ...
                 <div class="col-lg-4">
                    ...
                    <input type="text" id="kt_datepicker_3" name="fitness_cert_upto" class="form-control" placeholder="Fitness Certificate Valid Upto"/>
                    <span class="form-text text-muted"></span>
                </div>
            </div>
            <div class="form-group row">
             ...
             <div class="col-lg-4">
                ...
                <input type="text" id="kt_datepicker_3" name="permit_upto" class="form-control" placeholder="Permit Valid Upto"/>
                <span class="form-text text-muted"></span>
            </div>
        </div>
    </div>
